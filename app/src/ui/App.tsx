...
type View = 'chat' | 'settings' | 'persona' | 'providers'
  ...
  return (
    <div className="h-screen flex flex-col" style={{ background: '#0f0f23', color: '#e0e0e0' }}>
      ...
      <div className="flex-1 overflow-hidden">
        ...
        {view === 'settings' && <SettingsView onDone={() => setView('chat')} onOpenProviders={() => setView('providers')} onOpenPersona={() => setView('persona')} />}
