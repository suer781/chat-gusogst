...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.basic.fontSize': { zh: '字体大小', en: 'Font Size' },
  'settings.basic.eyeCare': { zh: '护眼模式', en: 'Eye Care' },
  'settings.basic.eyeCareToggle': { zh: '护眼模式', en: 'Eye Care Mode' },
  'settings.basic.eyeCareDesc': { zh: '减少蓝光，保护视力', en: 'Reduce blue light to protect eyes' },
  'settings.basic.customMapping': { zh: '自定义色温映射', en: 'Custom Color Temperature' },
  'settings.basic.glassTitle': { zh: '毛玻璃效果', en: 'Glass Effect' },
  'settings.basic.glassLabel': { zh: '毛玻璃', en: 'Frosted Glass' },
  'settings.basic.glassDesc': { zh: '开启半透明模糊背景效果', en: 'Enable semi-transparent blurred background' },
  'settings.basic.system': { zh: '跟随系统', en: 'System' },
  'settings.basic.light': { zh: '浅色', en: 'Light' },
  'settings.basic.dark': { zh: '深色', en: 'Dark' },
  'settings.basic.pureWhite': { zh: '纯白', en: 'Pure White' },
  'settings.basic.pureBlack': { zh: '纯黑', en: 'Pure Black' },
  'settings.model.label': { zh: '模型', en: 'Model' },
  'settings.model.desc': { zh: '管理 AI 模型和参数', en: 'Manage AI models and parameters' },
  'settings.model.autoUnderstand': { zh: '自主理解', en: 'Auto Understand' },
  'settings.model.autoUnderstandDesc': { zh: '根据当前系统提示词描述的性格情绪，调用模型自动推荐最佳参数', en: 'Auto-recommend optimal parameters based on system prompt personality analysis' },
  'settings.model.analyzing': { zh: '分析中...', en: 'Analyzing...' },
  'settings.model.startAnalyze': { zh: '开始分析', en: 'Start Analysis' },
  'settings.platform.label': { zh: '供应商', en: 'Provider' },
  'settings.platform.desc': { zh: '配置 API 密钥和数据源', en: 'Configure API keys and data sources' },
  'settings.memory.label': { zh: '记忆', en: 'Memory' },
  'settings.memory.cardDesc': { zh: 'AI 跨对话记住关键信息', en: 'AI remembers key info across conversations' },
  'settings.search.label': { zh: '联网搜索', en: 'Web Search' },
  'settings.search.cardDesc': { zh: '搜索引擎和数据源配置', en: 'Search engine and data source config' },
  'settings.about.label': { zh: '关于', en: 'About' },
  'settings.about.desc': { zh: '版本信息与开发者选项', en: 'Version info and developer options' },
  'search.bing.desc': { zh: '微软搜索，覆盖面广', en: 'Microsoft search, broad coverage' },
  'search.duckduckgo.desc': { zh: '隐私优先的搜索引擎', en: 'Privacy-focused search engine' },
